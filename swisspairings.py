...
class Draw():
    ...
    def __getMatchables(self, id_1):
        ...
        print "Check if there are other matchable players:"
        print "%s " % id_1, "can be matched with %s" % matchables

        return matchables

    def __getPlayerDataById(self, id_1):
        return None
    ...
    def __draw(self):
            ...
            if (player[0] not in self.alreadyDrawn):  # noqa
                ...
                if(len(self.current_pair) == 0):
                    ...
                    if(self.__alreadyMatchedCheck(player[0], self.current_pair[0][0]) or player[0] == self.current_pair[0][0]):  # noqa
                        ...
                        if(player[0] == self.current_pair[0][0]):
                            print "Player %s is already in current_pair" % self.current_pair[0][0]  # noqa
        ...
        print "Already drawn: %s" % self.alreadyDrawn
